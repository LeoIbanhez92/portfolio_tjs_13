...
async function getAboutGitHub() {
    try {
        ...
        const resposta = await fetch(
            'https://api.github.com/users/LeoIbanhez92',
        )
    ...
    <article class="about-content">
        ...
        <h2 style="color: #fff;">Sobre mim</h2>
        <p>Olá! Sou Leonardo, <span class="destaque">Desenvolvedor Fullstack</span> graduado em <span class="destaque">Análise e Desenvolvimento de Sistemas</span> pela Estácio de Sá. <br>
        Atualmente, aprofundo minhas competências técnicas no ecossistema <span class="destaque">JavaScript</span>
        (<span class="destaque">React</span> e <span class="destaque">Node.js</span>) por meio do bootcamp da <span class="destaque">Generation Brasil</span>,
        onde aplico conceitos de <span class="destaque">arquitetura limpa</span> e <span class="destaque">POO</span> em projetos práticos.</p>
        <p>Minha base tecnológica inclui experiência com <span class="destaque">Java</span>, <span class="destaque">Spring Boot</span>, <span class="destaque">TypeScript</span> e <span class="destaque">Angular</span>,
        focando sempre em soluções escaláveis e de alta manutenção. 
        Convido você a explorar meus repositórios no <span class="destaque">GitHub</span> ou baixar meu currículo para 
        conhecer mais sobre minha trajetória e habilidades.</p>
        ...
        <div class="buttons-container">
            ...
            <a href="./assets/docs/curriculum/leonardoHenriquesIbanhez.pdf" target="_blank" class="botao-outline">Currículo</a>
        </div>
...
async function getProjectsGitHub() {
    try {
        // Requisição do tipo GET para a API do GitHub
        const resposta = await fetch(
            'https://api.github.com/users/LeoIbanhez92/repos?sort=pushed&per_page=6',
        )
